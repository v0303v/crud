        ...
        <div class="justify_content_center">
            <div>
                <form action="" method="POST">
                    ...
                    <input type="text" name="llogin" value="<?php echo $llogin; ?>" placeholder="Enter your login">
                    <!-- <span class="error"></span> -->
                    <br>
                    <label for="">Password: </label>
                    <input type="text" name="lpassword" value="<?php echo $lpassword; ?>" placeholder="Enter your password">
                    <!-- <span class="error"></span> -->
                    <br>
